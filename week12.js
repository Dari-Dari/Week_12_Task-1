...
const makeFive = () => {
	...
	const power = 4;
	//Ваш код
	const sum5 = Math.pow(num, power);
	resultFive.textContent = sum5;
};
...
const makeSeven = () => {
	...
	const num2 = 7;
	//Ваш код
	const sum7 = num1 % num2;
	resultSeven.textContent = sum7
};
...
const makeTen = () => {
	const str = 'Hello';
	//Ваш код
	const index = str.charAt(2);
	resultTen.textContent = index;
};
...
const makeTwelve = () => {
	...
	resultTwelve.textContent = sumStr;
};
...
const makeFourteen = () => {
	...
	resultFourteen.textContent = lowStr;
};
...
const makeFifteen = () => {
	...
	resultFifteen.textContent = upperStr;
};
...
const makeSixteen = () => {
	const str = 'JavaScript';
	//Ваш код
	const string16 = str.substring(3); 
	resultSixteen.textContent = string16;
};
...
const makeSeventeen = () => {
	const str = 'JavaScript';
	//Ваш код
	const string17 = str.substring(3, 7); 
	resultSeventeen.textContent = string17;
};
...
const makeEighteen = () => {
	...
	//Ваш код
	const string18 = str.replace('world', 'JavaScript');
	resultEighteen.textContent = string18;
};
...
const makeNineteen = () => {
	const str = 'Hello, world!';
	//Ваш код
	const string19 = str.substr(7, 6);
	resultNineteen.textContent = string19;
};
...
const makeTwenty = () => {
	//Ваш код
	const string20 = Math.max(10, 25, 5, 30, 15)
	resultTwenty.textContent = string20;
};
...
const makeTwentyOne = () => {
	//Ваш код
	const random21 = Math.ceil(Math.random() * 10);
	resultTwentyOne.textContent = random21;
};
...
const makeTwentyTwo = () => {
	//Ваш код
	const string22 = Math.min(10, 25, 5, 30, 15)
	resultTwentyTwo.textContent = string22;
};
...
const makeTwentyThree = () => {
	//Ваш код
	const string23 = 2 ** 5;
	resultTwentyThree.textContent = string23;
};
...
const makeTwentyFour = () => {
	//Ваш код
	const string24 = Math.min(7, 3, 11, 5, 9)
	resultTwentyFour.textContent = string24;
};
...
const makeTwentyFive = () => {
	//Ваш код
	const string25 = Math.max(7, 3, 11, 5, 9)
	resultTwentyFive.textContent = string25;
};
...
const makeTwentySix = () => {
	//Ваш код
	const string26 = Math.random().toFixed(4);
	resultTwentySix.textContent = string26
};
...
const makeTwentySeven = () => {
	//Ваш код
	const string27 = Math.floor(Math.random() * 51) + 50;
		resultTwentySeven.textContent = string27;
};
...
const makeTwentyEight = () => {
	//Ваш код
	const string28 = Math.ceil(4.47);
	resultTwentyEight.textContent = string28;
};
...
const makeTwentyNine = () => {
	//Ваш код
	const string29 = Math.sqrt(16);
	resultTwentyNine.textContent = string29;
};
...
const makeThirty = () => {
	//Ваш код
	const string30 = Math.sqrt(25);
	resultThirty.textContent = string30;
};
